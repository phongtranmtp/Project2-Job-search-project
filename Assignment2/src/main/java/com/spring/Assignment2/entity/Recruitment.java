...
public class Recruitment {
    ...
    public Recruitment( String address, String createdAt, String description,
                       String experience, int quantity, String rankRe, String salary,
                       int status, String title, String type, int view, String deadline,
                       Category category, Company company,List<ApplyPost> applyPosts) {
    ...
    public void setRankRe(String rank) {
        this.rankRe = rankRe;
    }
